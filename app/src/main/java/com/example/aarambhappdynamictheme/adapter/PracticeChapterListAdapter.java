...
public class PracticeChapterListAdapter extends RecyclerView.Adapter<PracticeChapterListAdapter.MyViewHolder> {
    ...
    public PracticeChapterListAdapter(Context context, ArrayList<String> sixth_Chapter, ArrayList<YouTubePlayList> youTubePlayListArrayList) {
    ...
    @NonNull
    @Override
    public PracticeChapterListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.practice_test_list, parent, false);
        return new PracticeChapterListAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final PracticeChapterListAdapter.MyViewHolder holder, final int position) {
        ...
        holder.take_practice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                switch (class_id) {
                    case "1":
                        ...
                        intent.putExtra("ChapterNamePractice",getChapter);
                        //}
                    ...
                    case "2":
                        try {
                            ...
                            if(getChapter1.contains("Nutrition in animals")){
                                Toast.makeText(context, "No Practice Available", Toast.LENGTH_SHORT).show();
                            }
                            else {
                                ...
                                chap.setTopic(topicName);
                                AarambhSharedPreference.saveTopicNameToPreference(context, chapter);
                                Intent intent1 = new Intent(context, PraticesActivity.class);
                                //intent1.putExtra("7th_Details", playListId1);
                                intent1.putExtra("7thChapterNamePractice", getChapter1);
                    ...
                    case "3":
                        try {
                            ...
                            chap.setTopic(topicName);
                            AarambhSharedPreference.saveTopicNameToPreference(context, chapter);
                            Intent intent2 = new Intent(context, PraticesActivity.class);
                            //intent2.putExtra("8th_Details", playListId2);
                            intent2.putExtra("8thChapterNamePractice", getChapter2);
...
//                        break;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView chapter_testname, take_practice;
       ...
       String base_color_one,base_color_two;
        public MyViewHolder(@NonNull View itemView) {
            ...
            take_practice = itemView.findViewById(R.id.take_practice);
            ...
            textColorGradient.getColorTextGradient(take_practice, base_color_one, base_color_two);
        }
    }

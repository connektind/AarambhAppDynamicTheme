...
public class TestData implements Serializable {
    ...
    String TestId,ClassId1,CourseId,TopicId,
            ChapterId,TestQuestionType,TestQuestions,AnswerOption1,
